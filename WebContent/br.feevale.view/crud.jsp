...
<html>
	...
	<body>
		<form method="post" action="${pageContext.request.contextPath}/ShoppingCartManager" onsubmit="return validateForm('fruit');">
			<table>
				...
				<c:forEach var="arrayList" items="${arrayList}">
					<tr>
						...
						<td>
							<a href="default.asp"><img src="http://www.grocerycrud.com/assets/uploads/general/smiley.png" alt="HTML tutorial" class="images"></a>
							<a href="default.asp"><img src="http://www.grocerycrud.com/assets/uploads/general/smiley.png" alt="HTML tutorial" class="images"></a>
						</td>
						<td><input type="checkbox" name="fruit" id="cFruit" value="${arrayList.id}"><label for="cFruit"></label></td>
					</tr>
				</c:forEach>
				<tr><td colspan="5"><input type="submit" name="submit" value="Press me!"></td></tr>
			</table>
		</form>
